...
const images = [
  { src: '/cctv2.svg', link: 'https://example.com/page1' },
  { src: '/cctv1.svg', link: 'https://example.com/page2' },
  { src: '/cctv4.svg', link: 'https://example.com/page3' },
  { src: '/cctv3.svg', link: 'https://example.com/page4' },
